...
# https://urldefense.com/v3/__https://quarto.org/docs/reference/cells/cells-knitr.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_LJS6al4w$ 
fig-format: retina
code-overflow: wrap
...
The mass percent of SOC (by horizon) is converted into an "SOC stock" (units of $kg / m^{2}$) for either the entire depth of sampling (e.g. an entire soil profile) or within some depth interval (e.g. 0-100cm). Horizon-level stocks are summed over an entire profile or within a specified depth interval to give the total mass of SOC per unit area. Critical to this calculation are several soil properties::
  ...
  * $thick$ soil depth interval or horizon thickness in $cm$
...
$$
SOC_{stock} = \sum(soc~\times~thick~\times~D_{b}~\times~(1 - cf)~\times~10)
$$

where $soc$, $thick$, $D_{b}$, and $cf$ are measurements (or estimates) associated with soil samples that represent fixed sampling depths or genetic soil horizons. The final $10$ in the equation is a unit conversion factor with units of $\frac{kg / g}{m^{2} / cm^{2}}$.
...
<!-- ![caption here](soc-calculation-example-with-values.png) -->


## Effective use of Soil Data Access
Queries to SDA work best when there is a clearly defined set of associated records ("tabular data"), possibly defined by a soil survey area symbol, set of map unit names, set of map unit keys, set of component names, or spatial "area of interest" defined by a simple geometric shape (point, line, polygon).

Those familiar with MS SQL may want to write their own queries and submit directly to the SDA API. The {soilDB} package for R provides a number of convenient functions for simplifying interaction with SDA and related web services. Some of these functions include:

  * [`SDA_query()`](https://urldefense.com/v3/__http://ncss-tech.github.io/soilDB/reference/SDA_query.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_LO3MlDjw$ ): submit queries (MS SQL dialect of SQL) to SDA; results as a `data.frame` object
  
  * [`SDA_spatialQuery()`](https://urldefense.com/v3/__http://ncss-tech.github.io/soilDB/reference/SDA_spatialQuery.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_JIRBI7Hw$ ): submit spatial queries to SDA using common R spatial data types ({sf}, {terra}); results could be a `data.frame` or spatial data
  
  * [`fetchSDA()`](https://urldefense.com/v3/__https://ncss-tech.github.io/soilDB/reference/fetchSDA.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_Jgr1dr7A$ ): submit a query to SDA via specified "WHERE clause"; results are [`SoilProfileCollection` provided by the {aqp} package](https://urldefense.com/v3/__http://ncss-tech.github.io/aqp/articles/Introduction-to-SoilProfileCollection-Objects.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_JZvnUSAw$ )
  
  * [`fetchSDA_spatial()`](https://urldefense.com/v3/__https://ncss-tech.github.io/soilDB/reference/fetchSDA_spatial.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_IiNL49XA$ ): submit a vector of map unit keys to SDA; results are spatial data (map unit polygons)
  
  * [`mukey.wcs()`](https://urldefense.com/v3/__https://ncss-tech.github.io/soilDB/reference/mukey.wcs.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_Ix5PapCg$ ): submit a web coverage service (WCS) request (by bounding-box) for gridded map unit key data, provided by SoilWeb; results are {terra} `SpatRaster` objects

The [{soilDB} documentation](https://urldefense.com/v3/__https://ncss-tech.github.io/soilDB/__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_KmydRopA$ ) and associated tutorials contain detailed explanations of this functionality. 

  * [Soil Data Access (SDA) Tutorial](https://urldefense.com/v3/__http://ncss-tech.github.io/AQP/soilDB/SDA-tutorial.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_LNMvmz-A$ )
  * [SDA Point Query Examples](https://urldefense.com/v3/__https://ncss-tech.github.io/AQP/soilDB/SDA-point-query.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_ICtWRv5g$ )
  * [NCSS Lab Data via SDA](https://urldefense.com/v3/__https://ncss-tech.github.io/lab-data-delivery/SDA.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_KffMlxLg$ )
  * [WCS vignette](https://urldefense.com/v3/__https://ncss-tech.github.io/soilDB/articles/wcs-ssurgo.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_KgmPwJRA$ )
  * [Expanded WCS Demonstration](https://urldefense.com/v3/__http://ncss-tech.github.io/AQP/soilDB/WCS-demonstration-01.html__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_IEPNtYoQ$ )


## Soil Mapping Units
U.S. soil survey data (SSURGO) are organized by "map unit", representing a collection of one or more soils and/or miscellaneous areas (e.g. "mined land") that are delineated at a cartographic scale of approximately 1:24,000. See this excellent [presentation by James Brewer](https://urldefense.com/v3/__https://clctrust.org/wp-content/uploads/2022/01/USDA-What-are-Soil-Map-Units-and-a-Web-Soil-Survey.pdf__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_JmNZebbQ$ ) for a detailed description of soil survey map units and their interpretation. The [Ag Data Commons entry for SSURGO](https://urldefense.com/v3/__https://data.nal.usda.gov/dataset/soil-survey-geographic-database-ssurgo__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_KvR0a5pA$ ) contains additional useful links and metadata. A detailed background on soil mapping concepts can be found in [Chapter 4 of the Soil Survey Manual](https://urldefense.com/v3/__https://www.nrcs.usda.gov/sites/default/files/2022-09/SSM-ch4.pdf__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_JUo3YgoQ$ ).
...
# Worked Examples
Follow-along several fully-worked examples, from [St. Charles County, Missouri](https://urldefense.com/v3/__https://casoilresource.lawr.ucdavis.edu/gmap/?loc=38.89624,-90.42109,z14__;!!JYXjzlvb!gflEgVj3TXM9N64gOQW_wb8c97L8gu2FN9oJPR1_dtNrrY4elWVGoHo5sFe8ERRV7vI7yXpPWxdOzECrxIHbJxIwW_Kmcg1grQ$ ). Continue from above, with required libraries installed / loaded and custom functions sourced.
...
----------------------------
This document is based on `aqp` (`r utils::packageDescription("aqp", field="Version")`) and `soilDB` (`r utils::packageDescription("aqp", field="Version")`).
