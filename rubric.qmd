...
Below is the judging rubric for the competition. The majority of the judging will considers only what is provided in the final presentation on November 2nd. The only exception to this is the final section on "Open Data Principles". 

Each team's score will be the sum of their results for each category, and summed across judges. The three highest scoring teams win. If ties occur, the judges will decide these ties via consensus. 
...
*What approaches were used, are all relevant details adequately described, and are the methods used appropriate for the addressing the problem? Is this a novel approach to addressing the team problem statement?*
...
| 3  | The bare minimum was done to meet this requirement.  |        
| 4  | The impacts are largely stated, with some minor omissions and/or lack of details to understand.  |        
